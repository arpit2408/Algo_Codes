 ...
 *
 */
public class LargestContagiousArray {

	/**
	 * @param args
	 */
	public static void main(String[] args) {
		Integer[] b={-2,1,-3,4,-1,2,1,-5,4};
		...
		System.out.println(maxSubArray(Arrays.asList(b)));
	}
	...
	public static int maxSubArrays(final List<Integer> a) {
	    ...
	    for(int i=0;i<a.size();i++)
	    {
	        ...
	        else if(!finallist.contains(a.get(i)))
	        {
	            temp=sum+a.get(i);
	            if(temp>sum)
	            {
